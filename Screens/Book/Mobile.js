    ...
    return(
        <View>
            <View style={styles.Book}>
                ...
                <View>
                    <Text style={styles.EEI}>EEI3269 - Introduction to {'\n'}Mobile Application {'\n'}Development</Text>
                </View>
            </View>
            ...
            <View style={{margin:20}}>
                ...
                <Text style={{fontSize:18, textAlign:'justify'}}>You have logged in to the course EEI3269 - Introduction to Mobile Application Development of the Bachelor of Software Engineering Honours degree programme. This is a 2 credit optional course offered in Year 1.</Text>
            </View>
